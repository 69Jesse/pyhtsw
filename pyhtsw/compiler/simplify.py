...
def _can_merge(
    ...
    from pyhtsw.compiler.schedule import body_writes, conditions_read
...
def _merge_conditionals(
    ...
    *,
    ...
    from pyhtsw.compiler.limits import is_within_limits
    from pyhtsw.expression.condition.conditional_expression import ConditionalExpression
...
def _drop_unreachable(expressions: list['Expression']) -> bool:
    from pyhtsw.actions.flow import ExitFunctionExpression
