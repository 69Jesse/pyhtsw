...
LeatherArmorKey = Literal[
    'leather_cap', 'leather_tunic', 'leather_pants', 'leather_boots',
]


CookieItemKey = Literal['cookie']


PlayerSkullItemKey = Literal['player_head']


ColorType = int | str | tuple[int, int, int] | None


ItemKeyName = NonSpecialItemKey | DamageableItemKey | LeatherArmorKey | CookieItemKey | PlayerSkullItemKey


ItemKey = ItemKeyName | tuple[LeatherArmorKey, ColorType] | tuple[PlayerSkullItemKey, NBTCompound | None]


ENCHANTMENT_TO_ID: dict[EnchantmentName, int] = {
    'protection': 0,
    'fire_protection': 1,
    'feather_falling': 2,
    'blast_protection': 3,
